...
@Table(catalog = "ecommerce", name = "customer")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "EcommerceMysql/ecom/domain", name = "Customer")
...
public class Customer implements Serializable {
	...
	java.util.Set<ecom.domain.SalesOrder> salesOrders;
	...
	public Set<SalesOrder> getSalesOrders() {
		if (salesOrders == null) {
			salesOrders = new java.util.LinkedHashSet<ecom.domain.SalesOrder>();
		}
		return salesOrders;
	}
	...
	public void copy(Customer that) {
		...
		setZip(that.getZip());
		setSalesOrders(new java.util.LinkedHashSet<ecom.domain.SalesOrder>(that.getSalesOrders()));
	}
