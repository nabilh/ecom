...
<html>
<head>
<title>Edit <fmt:message key="salesorder.title"/> <fmt:message key="customer.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSalesOrderCustomer" method="POST" modelAttribute="customer">
