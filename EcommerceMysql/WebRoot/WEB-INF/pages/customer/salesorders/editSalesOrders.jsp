...
<html>
<head>
<title>Edit <fmt:message key="customer.title"/> <fmt:message key="salesorder.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCustomerSalesOrders" method="POST" modelAttribute="salesorder">
