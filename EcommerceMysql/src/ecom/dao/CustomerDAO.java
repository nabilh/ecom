...
public interface CustomerDAO extends JpaDao<Customer> {
	 ...
	 *
	 */
	public Customer findCustomerById(Integer id_1) throws DataAccessException;

	/**
	 * JPQL Query - findCustomerById
	 *
	 */
	public Customer findCustomerById(Integer id_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findCustomerByLastNameContaining
	 *
	 */
	public Set<Customer> findCustomerByLastNameContaining(String lastName_1) throws DataAccessException;

	/**
	 * JPQL Query - findCustomerByLastNameContaining
	 *
	 */
	public Set<Customer> findCustomerByLastNameContaining(String lastName_1, int startResult, int maxRows) throws DataAccessException;
