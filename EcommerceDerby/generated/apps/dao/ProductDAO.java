...
public interface ProductDAO extends JpaDao<Product> {
	 ...
	 *
	 */
	public Product findProductById(Integer id_1) throws DataAccessException;

	/**
	 * JPQL Query - findProductById
	 *
	 */
	public Product findProductById(Integer id_1, int startResult, int maxRows) throws DataAccessException;
