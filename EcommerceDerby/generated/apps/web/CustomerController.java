...
public class CustomerController {
	...
	public ModelAndView selectCustomer(@RequestParam Integer customernumberKey) {
	...
	public ModelAndView confirmDeleteCustomer(@RequestParam Integer customernumberKey) {
		ModelAndView mav = new ModelAndView();
	...
	public String deleteCustomer(@RequestParam Integer customernumberKey) {
		Customer customer = customerDAO.findCustomerByPrimaryKey(customernumberKey);
