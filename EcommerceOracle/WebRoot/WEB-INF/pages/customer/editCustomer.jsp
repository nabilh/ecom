				...
				<tbody>
					<tr>
						...
						<td>
							...
							<script type="text/javascript">Spring.addDecoration(new Spring.ElementDecoration({elementId : "customer_id",widgetType : "dijit.form.NumberTextBox",widgetAttrs : {promptMessage: "<fmt:message key="customer.id.help"/>"}})); </script>
								</c:when>
								<c:otherwise>
							${customer.id}
						&nbsp;
