...
public class CustomerDAOImpl extends AbstractJpaDao<Customer> implements
	...
	@Transactional
	public Customer findCustomerById(java.math.BigDecimal id, int startResult, int maxRows) throws DataAccessException {
		try {
	 ...
	 */
	@Transactional
	public Customer findCustomerByPrimaryKey(java.math.BigDecimal id) throws DataAccessException {
	...
	@Transactional
	public Customer findCustomerByPrimaryKey(java.math.BigDecimal id, int startResult, int maxRows) throws DataAccessException {
		try {
