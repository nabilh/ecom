...
public interface CustomerDAO extends JpaDao<Customer> {
	 ...
	 *
	 */
	public Set<Customer> findCustomerByCityContaining(String city_1) throws DataAccessException;

	/**
	 * JPQL Query - findCustomerByCityContaining
	 *
	 */
	public Set<Customer> findCustomerByCityContaining(String city_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Customer> findCustomerByStreetContaining(String street_1) throws DataAccessException;

	/**
	 * JPQL Query - findCustomerByStreetContaining
	 *
	 */
	public Set<Customer> findCustomerByStreetContaining(String street_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<Customer> findCustomerByZipContaining(String zip_1) throws DataAccessException;

	/**
	 * JPQL Query - findCustomerByZipContaining
	 *
	 */
	public Set<Customer> findCustomerByZipContaining(String zip_1, int startResult, int maxRows) throws DataAccessException;
